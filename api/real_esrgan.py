...
def configure(config: dict[str, Any]) -> tuple[Any, bool]:
    ...
    if model_name == 'RealESRGAN_x4plus':
        ...
        netscale = 4
        model_path = f'../weights/real-esrgan/{model_name}.pth'
    ...
    if use_face_enhancer:
        face_enhancer = GFPGANer(
            model_path='../weights/real-esrgan/GFPGANv1.3.pth',
            upscale=outscale,
            arch='clean',
...
def main():
    ...
    parser.add_argument(
        ...
        default=0.5,
        help=(
            'Denoise strength. 0 for weak denoise (keep noise),'
    ...
    parser.add_argument(
        ...
        type=str,
        default='realesrgan',
        help='The upsampler for the alpha channels. '
    ...
    dni_weight = None
    if args.model_name == 'realesr-general-x4v3' and \
        ...
        try:
            ...
            if args.suffix == '':
                save_path = os.path.join(
                    args.output, f'{imgname}.{extension}'
                )
            else:
                save_path = os.path.join(
